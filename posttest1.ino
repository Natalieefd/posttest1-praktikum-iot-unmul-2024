...
#define LED1 D8  // Pemilihan Pin D0
#define LED2 D3   // Pemilihan Pin D1

const char* ssid = "hrsna";       // Nama SSID AP/Hotspot
const char* password = "inimanusia";    // Password Wifi
...
void setup() {  //Pengaturan Pin
  ...
  webpage += "LED 2 : ";
  webpage += "<a href=\"LED2ON\"\"><button>ON</button></a>";
...
void loop() { 
  server.handleClient(); //Perulangan Program
}